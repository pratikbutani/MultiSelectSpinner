...
public class SingleSpinnerSearch extends Spinner implements OnCancelListener {
	...
	private SingleSpinnerSearchListener listener;
	MyAdapter adapter;
	...
	public void setItems(List<KeyPairBoolData> items, int position, SingleSpinnerSearchListener listener) {
	...
	public class MyAdapter extends BaseAdapter implements Filterable {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			convertView = inflater.inflate(R.layout.alert_dialog_listview_searchwithoutcheckbox_subview, null);
